...
# The class has a private class attribute __nb_objects
and a constructor __init__
# It can return a JSON string representation of a list of dictionaries
# It can save JSON strings of instance dictionaries to a file
# It can return a Python object from a JSON string representation
# It can return an instance with attributes already set
# It can return a list of instances
# It can save to and load from a CSV file
"""
...
# If no id is provided, the class attribute is incremented and set as the id
"""
        if id:
            self.id = id
        else:
